---
title: Integrate Razorpay Magic Checkout on React (Next.JS) Website - Shopify
heading: Integrate Magic Checkout on React (Next.JS) Website - Shopify
description: Steps to integrate Magic Checkout on your React (Next.JS) Website - Shopify integration.
---

# Integrate Magic Checkout on React (Next.JS) Website - Shopify
...
: `string` Order id from [Step 1.2](#12-create-order-id-on-server).
