...
> **Watch Out!**
> 
> This step is `mandatory` if you are creating a customer using [Create Customer in Server API](#11-create-a-customer-in-server). This is an `optional` step if you are directly [Create an Order in Server API](#12-create-an-order-in-server) without creating a customer.
> 
