...
description: Close a Customer Identifier using the Razorpay Dashboard.
---
...
To close Customer Identifiers automatically, specify a **Close By** date and time during [Customer Identifier creation](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/payments/smart-collect/create.md).
