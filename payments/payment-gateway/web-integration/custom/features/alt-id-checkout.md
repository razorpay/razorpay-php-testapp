...
According to the RBI circular, if a customer manually enters the card details during guest checkout (without saving the card information), the following guidelines must be adhered:
...
### 4. I use Razorpay Optimizer. How can I ensure that I am compliant?
         ...
         On behalf of all Optimizer merchants, Razorpay and your payment aggregator will take care of compliance. No additional steps are required from your end.
