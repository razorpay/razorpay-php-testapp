...
description: Approve a mandate using the Razorpay TPAP Pro API.
---
...
Use this endpoint to approve a mandate.

### Request

```curl: Curl
curl -X POST 'api.rzp..com/v1/mandates/:umn' \
...
: `string` The mandate identifier created by the payer.
