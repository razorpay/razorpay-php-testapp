---
title: Fetch a Payment with Expanded Offers Details
description: Fetch a Payment with Expanded Offers details using Razorpay Payments API.
---
...
client.payment.fetch("pay_JqLHMVryzMEafT",{"expand[]":"offers"})
...
instance.payments.fetch(paymentId,{"expand[]":"offers"})
...
`expand[]=offers`
: `string` Use to expand the offers applied to a payment, wherever applicable.
