---
title: Sample Payloads When Status is Funds On Hold
description: List of webhook events and associated payloads when the account is in Funds On Hold state.
---

# Sample Payloads When Status is Funds On Hold

## Account Funds On Hold

```json: Account Funds On Hold
{
  "entity": "event",
  "account_id": "acc_JNraR8O85H1atC",
  "event": "account.funds_hold",
  "contains": [
    "account"
  ],
  "payload": {
