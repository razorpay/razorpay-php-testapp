---
title: RBI Directive on Card Payments for Subscriptions
description: Check the changes in the RBI Guidelines released on 31st March 2021, regarding card payments for Subscriptions.
---

# RBI Directive on Card Payments for Subscriptions
...
#### 1. Will subscription plans created and in the active state before 1 April work from 1 April 2021?

Yes, subscription plans created and in the active state before 1 April will work post 1 April 2021.
...
#### 4. Will existing mandates registered through international cards be impacted?

No, the RBI circular is applicable only for issuing banks in India. International card mandates will continue to work.

#### 5. I want to enable customers to make payments through UPI only. How can I configure payment methods?
