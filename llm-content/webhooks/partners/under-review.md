---
title: Sample Payloads When Status is Under Review
description: List of webhook events and associated payloads when the account is in Under Review state.
---

# Sample Payloads When Status is Under Review

## Product Payment Gateway Under Review

```json: Payment Gateway Under Review
{
  "entity": "event",
  "account_id": "acc_JI0zziTMTmOmSI",
  "event": "product.payment_gateway.under_review",
  "contains": [
    "merchant_product"
  ],
  "payload": {
  ...
  "created_at": 1649673723
}
```

## Product Payment Link Under Review

```json: Payment Link Under Review
{
  "entity": "event",
  "account_id": "acc_JNuCwk8oQ59DKR",
  "event": "product.payment_links.under_review",
  "contains": [
    "merchant_product"
  ],
  "payload": {
  ...
  "created_at": 1650959936
}
```

## Account Under Review

```json: Account Under Review
{
  "entity": "event",
