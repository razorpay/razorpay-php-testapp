...
`source`
: `string` The point of failure in the specific operation (payment in this case). Check the [card](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#cards.md), [netbanking](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#netbanking.md), [wallets](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#wallet.md), [UPI Intent](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#intent-flow.md), [Cardless EMI](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#cardless-emi.md) and [Emandate](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#emandate.md) sections to know about the possible values for each method.

`step`
: `string` The stage where the transaction failure occurred. The stages can vary depending on the payment method used to complete the transaction. Check the [card](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#cards.md), [netbanking](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#netbanking.md), [wallets](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#wallet.md), [UPI Intent](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#intent-flow.md), [Cardless EMI](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#cardless-emi.md) and [Emandate](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/payments/payment-methods-error-parameters/#emandate.md) sections to know about the possible values for each method.
