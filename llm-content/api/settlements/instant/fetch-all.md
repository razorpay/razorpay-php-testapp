---
title: Fetch All Instant Settlements
description: Fetch All Instant Settlements using Razorpay Payments API.
---
...
List settlement = razorpay.settlement.fetchAllDemand(options)
...
List settlement = client.Settlement.FetchAllDemand();
