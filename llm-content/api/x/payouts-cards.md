...
With Payouts to Cards APIs, you can make payouts directly to a credit card, debit card or prepaid card. Payouts via **Visa Direct** and **MasterCard Send** are temporarily unavailable. Know more about the [supported networks](@/Applications/MAMP/htdocs/new-docs/llm-content/x/payouts/cards/#supported-networks-and-banks.md).
...
[Allowlist IPs](@/Applications/MAMP/htdocs/new-docs/llm-content/x/dashboard/allowlist-ip.md) that you use while making payouts via APIs and pass the [idempotency key](@/Applications/MAMP/htdocs/new-docs/llm-content/api/x/payout-idempotency.md). [Create a Contact](@/Applications/MAMP/htdocs/new-docs/llm-content/api/x/contacts/create.md) and [Fund Account](@/Applications/MAMP/htdocs/new-docs/llm-content/api/x/fund-accounts.md) before creating payouts.

Fork the Razorpay Postman Public Workspace and try the Payouts to Cards APIs using your [Test API Keys](@/Applications/MAMP/htdocs/new-docs/llm-content/x/dashboard/api-keys.md).
...
[About Payout to Cards](@/Applications/MAMP/htdocs/new-docs/llm-content/x/payouts/cards.md)
...
[Status Details](@/Applications/MAMP/htdocs/new-docs/llm-content/errors/x/payout-status-details.md)
