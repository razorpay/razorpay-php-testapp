...
`mode`_mandatory_
: `string` The mode to be used to create the payout. Available mode is `UPI`. Ensure you enter the payout modes in upper case as the payout modes are case-sensitive.
