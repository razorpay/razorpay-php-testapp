...
Use this endpoint to retrieve the details of a stakeholder. Know about the [various error responses](@/Applications/MAMP/htdocs/new-docs/llm-content/api/partners/errors.md) for this API.
