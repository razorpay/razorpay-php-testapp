---
title: Fetch All Customer Identifiers With TPV
description: Fetch all Customer Identifiers using the Razorpay **Smart Collect TPV** API.
---
...
@include smart-collect/api-tpv/fetch/all

### Response

@include smart-collect/api-tpv/fetch/all-res-code

### Parameters

@include smart-collect/api-tpv/fetch/all-query
