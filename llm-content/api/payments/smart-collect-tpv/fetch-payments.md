...
@include smart-collect/api-tpv/fetch/payments

### Response

@include smart-collect/api-tpv/fetch/payments-res-code

### Parameters

@include smart-collect/api-tpv/fetch/payments-path

### Parameters

@include smart-collect/api-tpv/fetch/payments-query
