...
`tnc_accepted`
: `boolean` Indicates if the [terms and conditions](https://razorpay.com/terms/) have been accepted or not.  
...
`live` 
: `boolean` Indicates if an account is live or not. Possible values:
...
```json: Success Response - Penny testing enabled
{
    "id": "acc_gHQwerty123ggd",
    "entity": "account",
    "name": "Gaurav Kumar",
