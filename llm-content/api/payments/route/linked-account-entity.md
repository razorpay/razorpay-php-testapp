...
`business_type`
: `string` The type of business operated by the account holder. Possible values: See [Business Types](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/route/integration-guide/#business-type.md). 

`profile`
: `object` The account holder's business details.

    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: See [Business Category](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/route/integration-guide/#business-category.md).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: See [Business Sub-Category](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/route/integration-guide/#business-sub-category.md).
