...
description: Pause or resume a mandate using the Razorpay TPAP Pro API.
---
...
Use this endpoint to pause or resume a mandate.
...
-d '{
  ...
  "description": "Sample Mandate Pause Request"
}'
```
