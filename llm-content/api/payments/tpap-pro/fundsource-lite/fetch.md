---
title: Fetch Fundsource Lite Details
description: Fetch Fundsource Lite account details using Razorpay Fundsource Lite API.
---
...
```curl: Curl
curl -X GET 'https://api.rzp..com/v1/upi/tpap/fundsource_lite/{lite_id}' \
...
`lite_id` _mandatory_
: `string` Unique identifier of the Fundsource Lite account to be retrieved for deregistration.
