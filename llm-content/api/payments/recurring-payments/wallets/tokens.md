...
String customerId = "cust_IjsVsJ7d27hxOs";

String tokenId = "token_J0BgMu8YDVusZa";

List customer = razorpay.customers.fetchTokens(customerId, tokenId);
...
instance.customer.fetchTokens(customerId, tokenId)
...
customerId = "cust_IjsVsJ7d27hxOs"

tokenId = "token_J0BgMu8YDVusZa"
