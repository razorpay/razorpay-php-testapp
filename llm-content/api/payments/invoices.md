...
> **Handy Tips**
> 
> You can only create non-GST Invoices via APIs. Non-GST invoices can be created in any of the [supported international currencies](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/international-payments#supported-currencies.md). You cannot add tax rates for invoices created using international currencies.
> 

Fork the Razorpay Postman Public Workspace and try the invoices APIs using your [Test API Keys](@/Applications/MAMP/htdocs/new-docs/llm-content/api/authentication#generate-api-keys.md).

[![Run in Postman](https://run.pstmn.io/button.svg)](https://www.postman.com/razorpaydev/workspace/razorpay-public-workspace/folder/12492020-6109230d-794c-4a01-b982-4d8479afee53)

### Related Guides

[About Invoices](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/invoices.md)
[Set Up Webhooks](@/Applications/MAMP/htdocs/new-docs/llm-content/webhooks/setup-edit-payments.md)
[Webhook Payloads](@/Applications/MAMP/htdocs/new-docs/llm-content/webhooks/invoices.md)
