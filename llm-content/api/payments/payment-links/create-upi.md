...
- Verify the `razorpay_signature` parameter to validate that it is authentic and sent from Razorpay servers. Know more about how to [Verify Signature](@/Applications/MAMP/htdocs/new-docs/llm-content/api/payments/payment-links/#verify-signature.md).

### Request

@include payment-links-v2/create-upi

### Response

@include payment-links-v2/create-upi-res
...
* solution: Ensure that you use [Live API keys](@/Applications/MAMP/htdocs/new-docs/llm-content/api/authentication#live-mode-api-keys.md) while passing UPI links.
