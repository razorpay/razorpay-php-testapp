...
> - You can also **Add an Allowed Payer** or **Delete an Allowed Payer** using [Smart Collect TPV](@/Applications/MAMP/htdocs/new-docs/llm-content/api/payments/smart-collect-tpv.md)  APIs.
> 
