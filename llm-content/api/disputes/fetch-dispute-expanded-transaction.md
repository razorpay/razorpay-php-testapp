---
title: Fetch a Dispute With ID (With Expanded transaction.settlement Details)
...
`expand[]=transaction.settlement` _optional_
: `string` Use to expand the transaction.settlement details of a dispute.
