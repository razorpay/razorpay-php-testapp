...
@include qr-codes-flipkart-intent-url/api/fetch/payments

### Response

@include qr-codes-flipkart-intent-url/api/fetch/payments-res
...
@include qr-codes-flipkart-intent-url/api/fetch/payments-query
