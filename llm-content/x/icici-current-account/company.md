---
title: Private / Public Limited Company / OPC KYC Documents
heading: Private / Public Limited Company / OPC
description: List of documents required to open a Current Account powered by RazorpayX in partnership with ICICI Bank for a private/public limited company/OPC.
---

# Private / Public Limited Company / OPC

This page has information on the documents required for a **Private/Public Limited** company to open a Current Account using RazorpayX in partnership with ICICI Bank.
...
KYC documents required for:
- All authorized signatory.
- All beneficial owners.
- All senior managing officials.

Here is a list of documents required from the customer end:

- Photo
- PAN Card
- ID and Address Proof (Refer the image below for list of acceptable documents)
...
1 | Board Resolution
---
2 | Board Resolution 2
---
3 | Covering Letter
---
4 | List of Directors (in ICICI Format)
---
5 | List of Shareholding pattern/Beneficial Owners holding pattern for those with more than 25% in the company (in ICICI Format)

Apart from the above mentioned documents and declarations, the customer has to submit:
