...
3. Select the type of report:
    ...
    - [TDS/Advance Tax Challans](@/Applications/MAMP/htdocs/new-docs/llm-content/x/tax-payments.md)
    - [Sub-Account Limits](@/Applications/MAMP/htdocs/new-docs/llm-content/x/payouts/sub-accounts.md)
    - [Purchase Orders](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/purchase-order.md)
    - [Vendor Advances](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/advances.md)
    - [Vendor Invoices](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/invoices.md)
...
![Generate Reports from the RazorpayX Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-dashboard-reports.jpg.md)
