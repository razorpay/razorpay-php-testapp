...
2. Navigate to **Vendor Payments** → **Advances** at the top of the screen.
    ![Advance payment on razorpayX](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/assets/images/x-vp-advances.jpg.md)
...
7. You can choose to **Attach** an existing Purchase Order and enter the **PO Number**, and add **+ NOTES**, as required.
    ![New advance payment](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/assets/images/x-new-advance.jpg.md)
...
![Apply advance payment](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/assets/images/x-apply-advance.jpg.md)
...
![Vendor advance state](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/assets/images/x-vendor-advance-state.jpg.md)
