...
After setup, change or modify the settings in your Tally application to make the [four flows](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally#four-flows.md) of the integration work seamlessly.

Watch the video below for the instructions or read along. 

[Video: https://www.youtube.com/embed/s2L4dmBjQGs?list=PLCwKlvaW1shYSe38ZxPE2e_jfuuxxwGmq]
...
- **Integrations in Account Settings**: 
   ...
   On the [RazorpayX Dashboard](https://x.razorpay.com/auth):
      ...
      1. Click the Tally icon button under **ACCOUNTING TOOL INTEGRATION** to download the plugin. 
         ![Tally highlighted in Accounting Tool Integrations in RazorpayX Settings](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-accounting-tool-integrations.jpg.md)

Start integrating RazorpayX with Tally by yourself or invite your Finance Team to do it. Know more about [managing teams and user roles](@/Applications/MAMP/htdocs/new-docs/llm-content/x/manage-teams.md) in RazorpayX. 
...
1. On your Windows device, right click on the `.tcp` file and click **Properties**.
   ![Information about the .tcp downloaded](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-integration-4.jpg.md) 
...
1. Go to **F1: Help** → **TDLs & AddOns** → **F4:Manage Local TDLs**. 
   ![Tally Prime set up using TDLs & AddOns and Manage Local TDLs in that order](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-int-tdls-addons.jpg.md)
...
- Under **F1:Help** to the top-right of the page:
   ...
   - **X:RazorpayX Sync**.
      ![Changes reflecting in Gateway of Tally page after installation.](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/tally-info.jpg.md)
...
1. Select **Yes** against **Enable RazorpayX Integration**.
    ![Say Yes against Enable RazorpayX Integration in Tally Prime](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-int-enable-sync-settings.jpg.md)
...
To fully configure the application, enable and disable the settings as per the [four flows](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally#four-flows.md) applicable to your business. 
- If you choose to [bring bills](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally/bring-bills.md) to Tally from RazorpayX, enable it at this step. 
- You can change the settings to sync [Purchase Vouchers](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally/sync-purchase-vouchers.md) and [Payment Vouchers](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally/sync-payment-vouchers.md) entries in Tally and RazorpayX. Select **Yes** against only one of them at a time. 
...
- [Create RazorpayX Ledger](@/Applications/MAMP/htdocs/new-docs/llm-content/x/tally-epayments/set-up.md)
