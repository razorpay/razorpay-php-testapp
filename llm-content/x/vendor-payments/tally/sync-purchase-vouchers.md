...
After you [set up and configure](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally/set-up.md) the integration, you can send your Purchase Vouchers to RazorpayX and sync them for reconciliation.
...
1. On this page:  
   ...
   ![Select Yes for Purchase Vouchers only](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-int-yes-purchase-vouchers.jpg.md)
...
1. Click **F9:Purchase**. Enter the invoice details to create a Purchase Voucher.
   ![Enter the Purchase Voucher details](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-int-sync-purchase-vouchers2.jpg.md)
1. Go to **Gateway of Tally** → **UTILITIES** → **RazorpayX**. Under **RazorpayX**, go to **RazorpayX Bills** → **Bill Status**.
   ![Steps to open the Bills Outstanding page](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-sync-purchase-vouchers3.gif.md)
...
1. From the right menu, click **F2:Period** and enter the duration in the **From** and **To** fields. The bills for that duration load on the page.
   ...
   ![All the unsynced bills appear as Not Synced under Bill Status](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/unsynced-bills-purchase-voucher.jpg.md)
...
1. Click spacebar on your keyboard to select a particular bill, or multiple bills, and click **S:Sync Selected Bills** to sync the selected bill/s.
   ![Sync a specific bill from the duration or sync all bills](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-tally-int-sync-purchase-vouchers4.jpg.md)
...
To verify the details of the invoice uploaded via Tally, click the invoice to open the invoice details view to the right of the page, as shown. 
   ...
   ![latest bill synced in RazorpayX Vendor Payments Overview](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/purchase-vouchers-vpdashboard.jpg.md)
...
> 
> If the section is empty, [create a Contact](@/Applications/MAMP/htdocs/new-docs/llm-content/x/contacts.md) of the type Vendor and [create a Fund Account](@/Applications/MAMP/htdocs/new-docs/llm-content/x/fund-accounts.md) for that Contact. 
> 
...
You have now successfully synced a Purchase Voucher made in Tally to RazorpayX. Know more about [syncing Payment Vouchers](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally/sync-payment-vouchers.md). 
...
All the payments made can be brought back to Tally. Know more about [bringing bills](@/Applications/MAMP/htdocs/new-docs/llm-content/x/vendor-payments/tally/bring-bills.md) to Tally from RazorpayX.
