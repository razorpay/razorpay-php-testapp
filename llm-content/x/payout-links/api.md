...
---
[Create Payout Links Using Contact Details](@/Applications/MAMP/htdocs/new-docs/llm-content/api/x/payout-links/create/use-contact-details.md) | Creates a Payout Link using customer's contact details like email id/mobile number. 
---
[Create Payout Links Using Contact ID](@/Applications/MAMP/htdocs/new-docs/llm-content/api/x/payout-links/create/use-contact-id.md) | Creates a Payout Link using the Contact id of the customer. [Create a Contact](@/Applications/MAMP/htdocs/new-docs/llm-content/x/contacts/#list-of-endpoints.md) to generate the Contact id. 
---
