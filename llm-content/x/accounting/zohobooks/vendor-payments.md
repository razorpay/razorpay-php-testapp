...
You can automate this process to an extent by setting [**Contact Rules**](@/Applications/MAMP/htdocs/new-docs/llm-content/x/accounting/zohobooks/#rules.md). This means that you can select a corresponding **Zoho Books Expense Account** to which you want the vendor payments made to that particular vendor, to sync. 
