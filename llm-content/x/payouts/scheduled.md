...
1. Create a [Contact](@/Applications/MAMP/htdocs/new-docs/llm-content/x/contacts/#contacts.md).
2. Create a [Fund account](@/Applications/MAMP/htdocs/new-docs/llm-content/x/contacts/#fund-accounts.md) for the Contact.
3. Create a payout.
...
![Schedule payout](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/x-schedule-payout.jpg.md)

### Bulk Upload

You can create Scheduled payouts created using [Bulk Upload](@/Applications/MAMP/htdocs/new-docs/llm-content/x/contacts/bulk-uploads.md). Select the following options while uploading the bulk upload file:
...
After a bulk file is uploaded, it is picked up for processing immediately. Know more about [bulk payouts](@/Applications/MAMP/htdocs/new-docs/llm-content/x/bulk-payouts.md).
...
![Scheduled Payouts Life Cycle](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/RZPX-scheduled_payout_life_cycle.jpg.md)

Know  more about the [states and the life cycle of a payout](@/Applications/MAMP/htdocs/new-docs/llm-content/x/payouts/states-life-cycle.md).
