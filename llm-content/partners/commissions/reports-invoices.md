---
title: Razorpay Partners | Reports and Invoices
heading: Commission Reports and Auto-generated Invoices
description: View the commission settlement reports and the various states of commission payouts.
---
...
The commission data under the **Earnings** tab is based on the Partner type and the following factors:
        ...
        The commission data is displayed if the third-party application with Razorpay is created (for client credentials) and [OAuth](@/Applications/MAMP/htdocs/new-docs/llm-content/partners/technology-partners/onboard-businesses/integrate-oauth.md) integration is necessary.
...
The **Invoices** section is available for partners who have commissions processed using the [Commission Payout with Auto-generated Invoice](@/Applications/MAMP/htdocs/new-docs/llm-content/partners/commissions/settlement-process/#automated-invoice-commission-payout.md) process. The following columns are displayed:
...
![download invoice](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/partners-download-invoice.jpg.md)

### Related Information
- [Commission for Payment Products](@/Applications/MAMP/htdocs/new-docs/llm-content/partners/commissions.md)
- [Referral Bonus for RazorpayX powered Current Accounts](@/Applications/MAMP/htdocs/new-docs/llm-content/partners/commissions/referral-bonus.md)
