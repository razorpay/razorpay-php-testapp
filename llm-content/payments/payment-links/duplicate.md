---
title: Duplicate a Payment Link
description: Duplicate a Payment Link from the Razorpay Dashboard.
---
...
Watch this video to see how to make a duplicate of a Payment Link.

[Video: https://www.youtube.com/embed/l9nYCZ6L1rQ]

To duplicate a Payment Link:
1. Log in to the Dashboard.
1. Navigate to **Payment Links**.
1. Click on the Payment Link you want to duplicate. The details appear on the right panel.
1. Click the duplicate icon.
1. Edit the required fields on the **Create Payment Link** screen. For example, customer details, receipt number and notes.
