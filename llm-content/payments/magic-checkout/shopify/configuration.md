...
>          
         ...
         4. Enable **COD as a payment option**.
             ![COD settings](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-cod-settings.jpg.md)
                 ...
                 Basic
                  ...
                  1. Configure the **Cart order value** by selecting an option based on your requirement:
                              ...
                              Charge a COD fee to customers who opt for the COD payment method. You can configure the order range and set a corresponding **Fee** accordingly.
                                 ...
                                 4. Click **Save slabs**. 
                                     ![Create COD eligibility slabs with COD charges](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-cod-slabs.jpg.md) 
                              ...
                              No COD charge will apply within the configured order range. The customer cannot view the COD payment method if an order value does not fall within the configured range.
                                 ...
                                 3. Click **Save slab**.
                                     ![Create COD eligibility slabs](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-free-cod.jpg.md)
...
>                       
                  ...
                  4. Select the country, state and city where the COD charges configured in the previous step should be applicable. Click **Confirm**.
                      ![Create COD zones](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-cod-zone.jpg.md)
                  5. Click **Save & apply**.
                  6. Navigate to **Manual Zipcode upload** and click **Upload ZIP codes** to offer COD only to specific ZIP codes.
                     ![Upload ZIP codes to offer COD only to specific ZIP codes](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-cod-shipping-pincode.jpg.md)
...
>                   
                  ...
                  4. Click **+ Add New Blocklist**. 
                     ![Add blocklist](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-blocklist.jpg.md)
...
### Method 2: Shopify Store
         ...
         2. Select the required products to add a COD tag.
             ![Select the products to add a COD tag](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-cod-configs.jpg.md)
...
>              
         ...
         3. Click the options icon below and click **Add tags**.
             ![Add the required COD tags](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-cod-add-tags.jpg.md)
...
>              
         ...
         5. Click **Save**.  
             ![Enter the COD charge and save the changes](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-cod-tag-save.jpg.md)
         6. Select a product you added a tag to and view the COD tag under the **Product organization** field to verify the changes.
                 ...
                 Customer Experience
                  ...
                  ![Customers view the tag at the checkout](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-cod-tag-customer.jpg.md)
...
### To enable partial COD:
         ...
         4. Turn on **Enable Partial COD** and click **Enable** to confirm.
             ![Enable partial COD](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-config-partial-cod-enable.jpg.md)
         5. Select the appropriate check boxes to enable **Partial COD** for specific categories:
             ...
             ![enable partial COD for specific categories](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-config-partial-cod-risk.jpg.md)
         6. You can select a default partial amount or set a custom amount for partial COD.
                     ...
                     ![choose a default amount](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-config-partial-cod-default-amt.jpg.md)
                     ...
                     To set a custom amount: 
                         ...
                         3. Click **Save**.
                         ![Enter a custom value](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-config-partial-cod-custom-amt.jpg.md)
...
>          
                 ...
                 Set Advanced Partial COD Slabs
                  ...
                  1. In the **Partial COD** section, click **Set advanced slabs**.
                      ![set advanced slabs](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-config-partial-cod-set-advanced.jpg.md)
                  2. Click **+ New Slab**.
...
>                       
                  ...
                  ![Partial COD advanced slab settings](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-config-partial-cod-advanced.jpg.md)
...
### COD Intelligence
         ...
         ![Enable COD intelligence](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-cod-enable.jpg.md) 
...
### Manually Review COD Orders
         ...
         4. Toggle on **Manually review COD orders**.
             ![Manual Review](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-manual-review-shopify.jpg.md)

         Once you enable manual review, you can review the COD orders and take necessary actions. Refer to the [COD Orders](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/magic-checkout/order-settings/review-cod-orders/#cod-orders.md) section for the next steps.
...
>          
         ...
         4. Click **Add Profile** in the **Custom Shipping Profile** section.
             ![Navigate to Shipping settings on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-shipping-settings.jpg.md)
         ...
         8. Enter the **Zone name** and select the country, state and city of your choice. 
             ![Add shipping zones to determine the shipping charges for each zone](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-add-shipping-zone.jpg.md)
...
>              
         ...
         11. Click **+ Add shipping method** and configure the **Shipping method & rate** for all the shipping zones added in the previous step.
             ![Configure the shipping rates for each zone](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-shipping-method.jpg.md)
         ...
         14. Configure the Shipping slab based on the **Amount** and **Weight** of the product and enter the minimum and maximum values respectively. For example, enter the minimum-maximum value as ₹500-₹900. If the amount of the product falls in that range, a shipping rate is applicable on the product. 
             ![Configure the shipping method](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-configure-shipping-method.jpg.md)
         ...
         16. Enter the estimated delivery timeline and click **Confirm**.
             ![Configure the shipping method](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-configure-shipping-delivery.jpg.md)
...
>              
             ...
             ![Enable Shipping settings on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-magic-enable-shipping-settings.jpg.md)
...
### Method 2: Shopify Store
         ...
         1. Log in to the [Shopify Store](https://accounts.shopify.com/store-login) and navigate to **Settings** → **Shipping and delivery**. 
             ![Shopify shipping](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-shipping.jpg.md)
...
>              
             ...
             ![Profile for general or custom shipping rates](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-profile.jpg.md)
         3. After creating a profile, click **Manage** to navigate to the shipping settings under that profile.
             ![Edit shipping settings](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-manage.jpg.md)
         4. Click **Create shipping zone** and add zones of your choice. Click **Done**.
             ![Shipping zones](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-shipping-zone.jpg.md)
         5. Click **Add rate** to add the shipping rates. You can create multiple shipping rates/options you want to show to your customers on Magic Checkout.
             ![Add shipping rates](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-add-rate.jpg.md)
         6. Select **Set up your own rates**. Follow the steps given below:
             ...
             1. Click **Done**.
                 ![Set up your own rates](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-own-rate.jpg.md)
...
### To enable international shipping:
         ...
         3. Navigate to **Shipping Setup** and enable **International Shipping**.
             ![International shipping](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-international.jpg.md)
...
>          
         ...
         2. In the **Checkout Setup** tab, enable **Auto fetch coupon** and click **Save settings**. This step is mandatory and allows you to display coupons to your customers at checkout. Even if you enable **Display this coupon at checkout** in the next steps, you must still enable Auto fetch coupon.
            ![enable auto fetch coupon to display coupons to customers](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-auto-fetch.jpg.md)
         ...
         4. Enable the following, as required:
             ...
             ![Enable toggles to configure coupons](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-toggle.jpg.md)
...
>             
         ...
         5. Navigate to **All Coupons**, click **+ Create Coupon** and **Select a Coupon Type** based on your requirement.  Alternatively, you can click **+ Create Coupon** next to **Coupons on Magic** in the **Setup** section and **Select a Coupon Type**.
              ![Create a coupon](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-create.jpg.md)
...
>                  ![To hide COD payment method when disabled](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-coupons-hide-cod.jpg.md)
>              
...
>                           
                  ...
                  6. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:  
                     ...
                     ![Combine coupons created with other categories](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-order-combine.jpg.md)
...
>                           
                  ...
                  7. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:  
                     ...
                     ![Combine coupons created with other categories](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-prod-combine.jpg.md)
...
>                           
                  ...
                  9. **Coupon combinations** *(optional)*: Combine this coupon with **Free shipping coupons** to provide free shipping along with the discount. If you select **Free shipping coupons** in this category then you must select the **BxGy discount coupons** check box in the **Free Shipping** category to combine the coupon.
                     ![Combine this coupon with free shipping](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-free-combine.jpg.md)
...
>                   
                  ...
                  2. Select **Products** or **Collections** to limit the discount to specific products or collections. Click **+ Add Products** or **+ Add Collections** respectively. Select the products or collections based on your requirement and click **Confirm**. You can add multiple products or collections.
                      ...
                      ![Configure coupon products purchased](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-product-config-bulk.jpg.md) 
                  ...
                  3. Select the **Discount type**.
                              ...
                              - **Fixed Discount**: In this type, a fixed amount is deducted from the original amount of the Y product.
                                  - **Discount amount**: Enter an amount by which the original price should be reduced. For example, if ₹150 is the flat discount applied, ₹150 is deducted from the original price.
                                  ![configure fixed discount](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-fixed-dis-bulk.jpg.md)
                              - **Percentage discount**: In this type, a set percentage of the amount is deducted from the original amount of the Y product. 
                                  - **Discount percentage**: The percentage by which the original price should be reduced. For example, if 10% discount is applied, on an order amount of ₹900, ₹90 will be deducted.
                                  ![configure percentage discount](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-percentage-dis-bulk.jpg.md)
                              ...
                              In this type, you can define a flat pricing per product.
                                  ...
                                  ![configure rate per product discount](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-rate-dis.jpg.md)
...
>                          
                      ...
                      ![Configure the coupon validity](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-validity-bulk.jpg.md)
...
>                           
                      ...
                      1. Select **click to upload** and choose the file you want to import. Click **Confirm**.
                      ![Configure details for free shipping coupon](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-free.jpg.md)
                  ...
                  5. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:  
                     ...
                     ![Combine this coupon created with other categories](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupons-free-combine.jpg.md)
...
>                           
                  ...
                  8. **Coupon combinations** *(optional)*: You can combine this coupon with **Free shipping coupons** category to offer free shipping on an order.
                     ![Combine this coupon created with other categories](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-coupon-freebie-combine.jpg.md)
                  9. Click **Create and Publish**.
...
### Method 2: Shopify Dashboard
         ...
         2. Navigate to **Discounts** and click **Create discount**.
             ![Create discounts](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-discount.jpg.md)
         3. You can create four types of discounts:
             ...
             ![Select discount](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-select-discount.jpg.md)
         4. **Select discount type** of your choice and enter the following details:
             ...
             1. Select the **Value** of the discount based on your requirement. You can also choose to add a discount to **Specific collections** or **Specific products**.
                 ![Select the value of the discount](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-config.jpg.md)
             ...
             1. Click **Save discount**.
                 ![Save Configs](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-configs.jpg.md)
...
### Disable Coupon Listing
         ...
         3. Navigate to **Checkout Setup**, disable **Auto fetch coupon** and click **Save settings**.
             ![Disable coupons](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-coupon.jpg.md)
...
Razorpay Magic SSO (Single Sign-On) offers a seamless login experience, helping you enhance conversions and gain valuable insights into user behaviour. Know more about how to setup [login with Razorpayt](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/magic-checkout/login-with-razorpay.md) on your shopify store.
...
Know how to [create offers](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/offers/create.md).
...
### To collect the billing address separately:
         ...
         3. Navigate to **Checkout Setup**, enable **Capture billing address** and click **Save settings**.
             ![Capture separate billing address](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-billing.jpg.md)
...
### To capture and validate GSTIN details:
         ...
         3. Navigate to **Checkout Setup**, enable **Capture GSTIN** and click **Save settings**.
             ![Capture customer's GSTIN](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-capture-gstin.jpg.md)
...
### To capture order instructions:
         ...
         3. Navigate to **Checkout Setup**, enable **Capture order instructions** and click **Save settings**.
             ![Capture customers order instructions](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-shopify-order-inst.jpg.md)
...
### To activate Google analytics:
         ...
         4. Select the integration type from the drop-down list. 
             ![Select the integration type to configure GA](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-ga-integration.jpg.md)
         
             
                 Integrate with frontend. Enable the events of your choice and click **Save events**.
                 ![Configure and save the events](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-ga-events.jpg.md)
...
>                  
                 ...
                 2. Click **Integrate backend →**. 
                     ![Enter the GA credentials to integrate backend](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-ga-cred.jpg.md)
...
### To integrate Facebook ads:
         ...
         4. Select the integration type from the drop-down list. 
             ![Select the integration type to configure Facebook Ads](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-facebook-integrations.jpg.md)
         
             
                 Integrate with frontend. Enable the events of your choice and click **Save events**.
                 ![Configure and save the events](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-facebook-events.jpg.md)
...
>                  
                 ...
                 2. Click **Integrate backend →**. 
                     ![Enter the GA credentials to integrate backend](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-facebook-creds.jpg.md)
                 3. Enable the events of your choice and click **Save events**.
                     ![Configure and save the events](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-facebook-events.jpg.md)
...
### To enable gift card settings:
         ...
         4. Once you enable the gift card settings, you can also enable the following options **if required**:
             ...
             ![Configure the gift card options if required](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-shopify-gift-config.jpg.md)
