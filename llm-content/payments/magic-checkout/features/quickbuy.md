---
title: QuickBuy | Razorpay Magic Checkout Features
heading: QuickBuy
description: Streamline checkout with QuickBuy’s 1-click payment and order placement. Minimise steps and speed up transactions for a fast, seamless customer experience.
---
...
- **Smart Address and Shipping Method Selection**: Automatically selects the most suitable address and shipping option, minimising customer effort and ensuring a seamless checkout process.
...
3. **Pre-selected shipping method**: The default shipping method is free if available; otherwise, the lowest-cost option is chosen, with the option to change it if required.
4. **Preferred payment method**: The most frequently used payment method is pre-selected. If the user changes their payment method, the system recalculates and applies the best available offer to the new method, notifying them of the updated total.
5. **Single-click purchase**: Customers complete their purchases in a single click.
