...
>     
    ...
    ![Opt for Manual Review on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-enable-manual-review.jpg.md)
6. Enter the required details based on the platform of your e-commerce website to align your actions performed on the Razorpay Dashboard with your e-commerce platform.
            ...
            Enter the **Consumer Key** and **Secret**. Follow the steps given below:
                ...
                1. Click **Add key**.
                    ![REST APIs](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-rest-api.jpg.md)
                1. Enter the required details and click **Generate API Key**.
                    ![Generate keys](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-generate-apis.jpg.md)
                1. Copy the API keys and paste them onto the Razorpay Dashboard. Click **Submit**.
                    ![Submit keys on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-submit-keys.jpg.md)
            ...
            Enter the **URL to review orders API**, **User name** and **Password**. To generate the URL, click **instructions** and follow the steps. Copy the information and paste it on the Razorpay Dashboard. Click **Submit**.
                ![Submit Keys on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-ecommerce-platform-submit.jpg.md)
...
![Select order id to view the risk reasons, recommendations and customer details](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-risk.jpg.md)
...
### Approve Order
         ...
         ![Approve order based on the risk level](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-approve-order.jpg.md)
        

    
### Cancel Order

         You can cancel the order based on the risk level and our recommendation. For example, if we have noticed a high return behaviour associated with this order; we recommend cancelling the order. The order status will change to cancelled on the COD orders tab and your [e-commerce platform](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/magic-checkout/order-settings/review-cod-orders/#e-commerce-platform.md). Click the **cancel icon** to cancel the order.
         ![Cancel Order based on the risk level](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-cancel-order.jpg.md)
...
### Mark Order On Hold
         ...
         ![On hold order based on the risk level](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-hold-order.jpg.md)
        

You can view the orders in the respective tabs, **Approved Orders**, **Canceled Orders** and **On Hold Orders**.
![View the order in the respective tabs](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-checkout-review-orders-tabs.jpg.md)
...
### WooCommerce Dashboard
         ...
         ![WooCommerce order status based on the actions on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-rto-orders-woocommerce-status.jpg.md)
...
### Shopify Dashboard
         ...
         ![Shopify order status based on the actions on the Razorpay Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/magic-rto-orders-shopify-status.jpg.md)
        

### Related Information 
[COD Review Workflow](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/magic-checkout/order-settings/review-cod-orders/workflow.md)
