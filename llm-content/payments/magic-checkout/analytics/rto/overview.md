---
title: RTO Overview | Razorpay Magic Checkout
heading: RTO Overview
description: Check the various RTO-related widgets available using Razorpay Magic Checkout on the RTO Analytics Dashboard.
---

# RTO Overview

The **Overview** tab on the RTO Analytics Dashboard provides an in-depth view to understand the RTO rate for prepaid and COD orders made on Magic Checkout over a period of time.
