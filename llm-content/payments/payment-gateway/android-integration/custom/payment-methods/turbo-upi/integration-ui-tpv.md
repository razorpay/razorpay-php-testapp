...
>                      
                 ...
                 ```
                        ...
                        Request Parameters
                         ...
                         ---
                         `setCustomerID` | The unique identifier of the customer. You can create `customer_id` using the [Customers API](@/Applications/MAMP/htdocs/new-docs/llm-content/api/customers.md).
                         ----
                         `setActivity` | Sets the context or activity for the operation.
                         ---
                         `setOrderID` | Order ID generated via [Orders API](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/#upi-only.md).
                         ----
