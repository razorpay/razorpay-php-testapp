---
title: Reconcile Shopify Orders on the Dashboard
description: Reconcile payments made on your Shopify store via Razorpay Dashboard.
---

# Reconcile Shopify Orders on the Dashboard
...
### Reconcile Multiple Payments
         ...
         3. Click **Export** to export the data. The **Payment References** column in the file contains the payment ids.
            ![Export Shopify order data](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/shopify-select-orders.jpg.md)
...
- [Integrate with Shopify Plugin](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/payment-gateway/ecommerce-plugins/shopify-razorpay-secure.md)
- [Shopify FAQs](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/payment-gateway/ecommerce-plugins/shopify-razorpay-secure/faqs.md)
