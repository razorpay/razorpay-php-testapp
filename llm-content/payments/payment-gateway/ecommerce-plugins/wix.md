---
title: Prerequisites | Wix - Prerequisites
heading: Prerequisites
description: Check the prerequisites before you integrate your Wix website with Razorpay Payment Gateway.
---

# Prerequisites

- **Troubleshooting & FAQs**: Troubleshoot common error scenarios and find answers to frequently asked questions about the Razorpay Wix Extension.
...
- Generate the [API Keys](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/api/authentication.md#generate-api-keys) from the Dashboard. To go live with the integration and start accepting real payments, generate Live Mode API Keys and replace them in the integration.
  ...
  - **Video Tutorial**: Watch the video before you start integrating the Wix extension with Payment Gateway.

  - **Integration Steps**: Check the steps to integrate the Wix extension with Payment Gateway.

## Supported Products

Razorpay Wix Plugin is only supported on Web Standard Checkout and the following products: 
