...
![Configure Go integrated payment gateway checkout based on your requirement](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/web-integration-checkout-new.jpg.md)
...
>          **Handy Tips**
> 
>          You can capture payments automatically with one-time [Payment Capture setting configuration](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/server-integration/go/integration-steps/#3-go-live-checklist.md) on the Dashboard.
>          
...
>                   **Handy Tips**
> 
>                   Test your integration using these [test cards](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/server-integration/go/integration-steps/#2-test-integration.md).
>                   
