---
title: Manage Subscription Buttons
description: Check the actions you can perform on a Subscription Button.
---
...
2. Click the **Subscription Buttons** tab, and then click on the link of the button that you want to modify.
3. The button details appears as shown.
    ![](/docs/assets/images/payment-button-subscription-button-button-pl.jpg)
...
![](/docs/assets/images/payment-button-subscription-button-edit-button.jpg)
...
![](/docs/assets/images/payment-button-Duplicate-payment-button-1.jpg)
...
1. In the top right corner of the page, click **Settings Icon**, and then click **Post Payment Message**.
    ![](/docs/assets/images/payment-button-subscription-button-post-payment-msg.jpg)
...
![](/docs/assets/images/payment-button-subscription-button-button-setttings.jpg)
...
You can search Subscription Buttons, Recurring Payments and One-Time Payments.
     ...
     4. Click **Search**.
     ![](/docs/assets/images/payment-button-subscription-button-search-sub-button.jpg)
     ...
     5. Click **Search**.
     ![](/docs/assets/images/payment-button-subscription-button-search-recurring-payments.jpg)
     ...
     4. Enter the other values as appropriate.
     5. Click **Search**.
     ![](/docs/assets/images/payment-button-subscription-button-search-one-time-payments.jpg)
...
You can view the statuses of Subscription Button, Recurring Payments and One-Time Payments.
        ...
        2. View the status of a button against each Subscription Button under the **Status** column.
            ![](/docs/assets/images/payment-button-subscription-button-sub-button-status.jpg)
        ...
        ![](/docs/assets/images/payment-button-subscription-button-rp-status.jpg)
        ...
        ![](/docs/assets/images/payment-button-subscription-button-ot-status.jpg)
...
1. Navigate to **Payment Button** on the Dashboard, and then click the **Subscription Buttons** tab.
2. Click the link of the button that you want to view.
3. Scroll down, and then click the Subscription Id which you want to modify.
...
![](/docs/assets/images/payment-button-subscription-button-subscription-status.jpg)

![](/docs/assets/images/payment-button-subscription-button-cancel-subscription.jpg)

### Duplicate a Subscription

Click the **Duplicate icon** and update as appropriate.

![](/docs/assets/images/payment-button-subscription-button-duplicate-sub.jpg)

### Update an Active Subscription

You can update an Active Subscription as follows:
1. Click **Update** button.
    ![](/docs/assets/images/payment-button-subscription-button-update-sub.jpg)
2. Modify the subscription details as you want.
    ![](/docs/assets/images/payment-button-subscription-button-update-sub1.jpg)
3. Review the changes, and then click **Update Subscription**.
    ![](/docs/assets/images/payment-button-subscription-button-update-sub2.jpg)
