---
title: Add Facebook Pixel in Payment Success Page
...
# Add Facebook Pixel in Payment Success Page
...
1. Click **Configure** against **Redirect URL and Custom Message**.
1. In the modal that appears, enable **Redirect URL**.
1. Add the redirect URL in the field.
1. Click **Save**.

![](/docs/assets/images/payment-button-redirect.jpg)
