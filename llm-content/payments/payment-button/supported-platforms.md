---
title: About Plugins
description: Embed Razorpay Payment Buttons on websites built on platforms such as Wix, Weebly, Blogger and Google Sites.
---

# About Plugins

You can embed Razorpay Payment Button on custom-built websites and those built on popular platforms such as: 
...
[Video: https://www.youtube.com/embed/mpKggEAOXrI]

To embed a Payment Button on your Wix site:
1. Log in to your Wix site and switch to Editor mode.
2. Navigate to **Add** → **Embed** → **Custom Embeds**.
3. Select **HTML iframe**.
4. Click **Enter Code** and select **Code**.
5. Paste the Button code that you copied from the Dashboard and click **Apply**. The Payment Button appears. You can drag and place it wherever required.
...
[Video: https://www.youtube.com/embed/Wq8MkcAJNdU]
...
6. Paste the Button code that you copied from the Dashboard and click out of the box. This saves the code.
...
[Video: https://www.youtube.com/embed/LgHpK-nbxn8]

To embed a Payment Button on your Blogger site:
1. Log in to your Blogger site and navigate to Editor mode.
2. Navigate to the page on which you want to place the button.
3. Switch to **HTML view**.
4. Paste the Button code that you copied from the Dashboard and click **Update**.
...
[Video: https://www.youtube.com/embed/NHt60vR_Ahg]
...
4. Paste the Button code that you copied from the Dashboard and click **Next**.
5. Click **Insert**.
...
[Video: https://www.youtube.com/embed/77ZWdlra4lw]
...
4. Paste the Button code that you copied from the Dashboard.
...
[Video: https://www.youtube.com/embed/4MCy8Blo4Pw]

## Drupal

To embed a Payment Button on your Drupal Website:

1. Download the plugin from the [Drupal](https://www.drupal.org/project/payment_button_drupal_plugin) Website.
