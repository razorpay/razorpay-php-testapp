...
description: Accept payments from European customers using Sofort.
---

# International Payments - Sofort

Sofort is a fast and easy payment method that enables customers to make payments directly from their bank accounts. It has a user base of 20 million in [8 countries](#supported-countries) across Europe.
...
2. Your customer opens Razorpay checkout and selects Sofort as the payment method.
3. Razorpay redirects the customer to a Sofort-hosted payment page with a list of available banks in their country.
