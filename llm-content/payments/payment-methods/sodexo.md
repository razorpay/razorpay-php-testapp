...
![sodexo checkout](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/sodexo-checkout.jpg.md)
...
### Step 1: Enable Optimizer and Add PayU as Payment Provider
         ...
         1. Enable [Optimizer](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/optimizer.md) on your Razorpay account.
         2. Log in to the Dashboard and navigate to **Optimizer**.
         3. [Add PayU as a payment provider](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/optimizer/payu#add-payu-as-a-payment-provider.md).
         4. Select `card` and `sodexo` payment methods and submit.
             ![Add Salt Key sodexo](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/add-key-salt-new-payu-sodexo.jpg.md)
...
### Step 2: Configure Sodexo as a Payment Method
         ...
         2. Select **Sodexo** from the list of payment methods and click **Request**. Know more about [how to request for a payment method](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/dashboard/account-settings/payment-methods#request-for-payment-methods.md).
             ![sodexo request](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/sodexo-request.jpg.md)
