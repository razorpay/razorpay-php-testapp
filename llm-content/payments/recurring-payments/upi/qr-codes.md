...
1. The QR Code is available on the desktop Standard Checkout for UPI Autopay.
    ![Recurring Payments QR Intent](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/qr_rp.gif.md)
...
Yes. You can use the QR Code to accept Recurring payments in any of our [supported international currencies](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/international-payments/#supported-currencies.md).
