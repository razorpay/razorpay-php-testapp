...
- You must have [international payments](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/international-payments.md) enabled for your account.
...
To enable/disable Non-3D Secure transactions, follow these steps:
         ...
         3. Select **International Payments** and click **Request** besides **Support for Non-3D Secure transactions** under **International Cards**.
            ![Disable Non-3DS](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/non-3ds-disable.jpg.md)
...
>          
         ...
         ![Enable Non-3DS](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/non-3ds-enable.jpg.md)
