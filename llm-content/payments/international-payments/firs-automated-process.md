---
title: FIRS Automated Process
description: Know about FIRS certificate, why you need it and how to obtain it from the Razorpay Dashboard.
---

# FIRS Automated Process

FIRS Certificate is a document that acts as evidence that you have received funds from a foreign country. The document is recognised as proof in scenarios such as getting GST refunds, claiming drawbacks from the government, or being required by beneficiary banks for compliance purposes. You can now generate FIRS from the Dashboard.
