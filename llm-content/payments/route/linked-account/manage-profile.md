...
description: Manage your Linked Account profile and add team members from the Linked Account Dashboard.
---

# Manage Profile and Team - Linked Account Dashboard

Linked Account users can access [Profile](#manage-profile) and manage their [Team](#manage-team).
...
1. Log in to the Linked Account Dashboard and click **Account Settings** menu from the left pane.
2. Go to **Manage Team** tab.
3. Enter the email address of the member you want to invite and click **Send Invitation**.
