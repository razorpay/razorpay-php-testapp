...
![View Default Rule](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/optimizer-view-default-rule.jpg.md)

## Edit Default Rule
To edit the default rule:
1. Click **View Default Rule**.
2. In the side pane, click **Edit Rule**.
    ![Edit Default Rule](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/optimizer-edit-default-rule.jpg.md)
...
4. Update the priority. Let us assume you want to ensure that 80% of transactions are routed through Razorpay and 20% through payment gateway ABC. To do this:
    ...
    3. In the new row, enter `20` in the **Route** field and select `ABC` against the **payment via** field.
        ![Edit Default Rule Details](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/optimizer-edit-default-rule-details.jpg.md)
    4. Click **Next**.
