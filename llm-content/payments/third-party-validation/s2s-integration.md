...
With Razorpay, you can comply with the SEBI guidelines for online payment collections by offering TPV integrations with [ major banks](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/bank-list.md) at Checkout. Customers can make payments using netbanking, debit card or UPI. UPI supports both [Collect](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/upi/collect.md) and [Intent](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/upi/intent.md) flows.
...
> **What's New**
> 
> Customers can now select card as the payment method and make payments only through their debit cards. Know more about [Debit Card TPV](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/debit-card.md)
> 
...
- [Netbanking](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/netbanking.md)
  
Customers select netbanking as the payment method and make payments only through their registered bank accounts.
- [Debit Card](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/debit-card.md)
...
- UPI
    - [Collect Flow](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/upi/collect.md)
...
Customers select UPI as the payment method and enter their registered UPI ID. They manually open their UPI PSP app and complete the payment.
    - [Intent Flow](@/Applications/MAMP/htdocs/new-docs/llm-content/payments/third-party-validation/s2s-integration/upi/intent.md)
