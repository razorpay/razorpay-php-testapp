...
description: List of QR Code states. Find descriptions for active and closed states.
---
...
Status | Description
---
`active` | Indicates that the QR Code has been created and is ready to accept payments. Know more about [creating a QR Code.](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/payments/qr-codes/create.md)
---
`closed` | Indicates that the QR Code has been closed. Customers cannot make payments using a closed QR Code. Know more about [closing a QR Code.](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/payments/qr-codes/close.md)
