---
title: Webhooks
description: Steps to set up webhooks on the Razorpay Dashboard.
---
...
> 
> 
> **Next Step - Validate and Test Your Webhooks**
> 
...
1. The **Webhook Setup** pop-up page is displayed. You can modify the following:
    ...
    - Alert Email
    - Active Events
   ![Edit Webhooks on Dashboard](https://raw.githubusercontent.com/razorpay/razorpay-php-testapp/markdown-docs/llm-content/assets/images/webhooks-webhook-edit-2.jpg.md)
