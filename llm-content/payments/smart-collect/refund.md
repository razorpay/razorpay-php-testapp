...
description: Refund payments made by customers to your Customer Identifiers.
---
...
2. In the right pane, click the **Issue Refund** button.
    ![Issue Refund](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/va_issue_refund.jpg.md)
3. A dialog box appears where the refund amount can be entered.
    ...
    ![Issue Full Refund](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/sc_full_refund.jpg.md)
    - Partial Refund: Enter the amount you want to refund. Enter **Comments**, if any, and click the **Issue Partial Refund** button.
    ![Partial Refund](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/va_partial_refund.jpg.md)
