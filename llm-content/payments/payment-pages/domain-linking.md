...
description: Create a customised URL for your Payment Page.
---
...
![Example website](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-mahesh.jpg.md)
...
2. Select the page you wish to link to your domain and click **Edit Page**.
    ![Edit Page](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-domain-edit-page.jpg.md)
3. This opens the page in edit mode. Click **Page Settings**.
    ![Page Settings](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-page-settings.jpg.md)
4. In the pop-up page that appears, click **Connect Domain**. 
    ![Connect Domain](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-connect-domain.jpg.md)
5. Select a subscription plan that works for you. We offer 3 subscription plans for you to choose from:
    ...
    ![Domain Linking Pricing Plans](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-domain-linking-pricing-plans.jpg.md)
6. Select a plan of your choice and click **Continue**.
    ![Select Plan for Pricing](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-domain-linking-select-plan.jpg.md)
7. Enter the domain or sub-domain you wish to use as your Payment Page's URL and click **Next**.
    ![Add Domain Name](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-domain-name.jpg.md)
8. Go to your domain and update the DNS values after receiving them. Given below is an example from Google Domains:
    ![Google Domain Page](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-google-domains.jpg.md)
9. After updating the DNS values, select the check box that asks if you have updated the DNS values and click **Verify connection**.
    ![Update DNS Values](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-update-dns.jpg.md)
10. After your domain is connected, customise the URL by clicking **Okay, customize URL**.
    ![Domain Connected Message](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-domain-connected.jpg.md)
...
2. In the pop-up page that appears, select one of these:
    - **Use my domain**: Select this option to customise your domain link name as per your preference. For example, assam-flood-relief-funds.
        ![Use my Domain option](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-use-my-domain.jpg.md)
    - **Use Razorpay's domain**: Select this option to use Razorpay's domain.
        ![Use Razorpay's Domain option](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-use-rzp-domain.jpg.md)
    - Click **Save**.   
4. **Click Save and Update** after customising domain link.
    ![Save your Domain](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-save-update.jpg.md)

Your page is now live with the updated domain link.
![Domain changes saved](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-changes-saved.jpg.md)
...
2. Click **Page Settings**. In the pop-up page that appears, click **Remove domain**.
    ![Remove Domain option](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-click-remove-domain.jpg.md)
3. Click **Yes, remove domain** to confirm the removal.
    ![Domain removal confirmation](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-confirmation-remove.jpg.md)  
4. You have successfully removed your domain from your Payment Page. Click **Save**.
    ![Domain removed confirmation](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/pp-domain-removed.jpg.md)
