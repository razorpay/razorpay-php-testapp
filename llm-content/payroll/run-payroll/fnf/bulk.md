...
- [Hold Salary and Pay Compliance](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/run-payroll/fnf.md). 

Know more about [employee dismissal](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/run-payroll/#terminate-and-run-last-payroll.md).
...
1. Navigate to **ADMIN OPTIONS** → **People** and click **Bulk Full & final Initiation**.
    ![RazorpayX Payroll Bulk FNF initiate](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-bulk-fnf-people.jpg.md)
...
### How to fill the template correctly?
                 ...
                 - Ensure the employees for whom you are initiating FnF in bulk are not the orgnaisation's [administrators](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/user-roles-workflows/#view-collaborators.md).
                 - You can start [holding salary](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/run-payroll/fnf.md) from a month where the payroll is not yet finalised. 
    ...
    1. Click **Upload & Preview**. 
        ![Payroll Create Bulk FnF ](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-bulk-fnf-initiation.jpg.md)
...
### How to fill the template correctly?
    ...
    1. Click **Upload & Preview**.
        ![Payroll settle bulk FnF](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-bulk-fnf-settlement.jpg.md)
...
1. Click **Replace File** to re-upload the file on the Dashboard. 
    ![Payroll Bulk FnF Resolve errors](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-bulk-fnf-error.jpg.md)
...
### 1. I want to hold the salary of a single employee. Is it possible?
            ...
            Yes, you can withhold the salary of an individual employee. Refer to [Hold Salary, Pay Compliance](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/run-payroll/fnf.md).
...
- [About Employee Dismissal](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/run-payroll/#terminate-and-run-last-payroll.md)
- [About Salary Additions/Deductions](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/run-payroll/#attendance-based-salary-calcuation.md)
