---
title: Reverse Loss of Pay (RLOP) previously deducted on the Payroll Dashboard
heading: Reverse Loss of Pay (RLOP)
description: Reverse the previously deducted Loss of Pay (LOP) for employees.
---

# Reverse Loss of Pay (RLOP)

In some cases, your employees may report incorrect loss of pay (LOP) deductions for the previous six months in their payslips. This creates Reverse LOP (RLOP) arrears, which you must pay.

To pay the RLOP arrears, you can reverse the LOP deductions for such employees. Ensure you finalise the payroll for the previous months to add RLOP.
...
1. On the **Add Reverse LOP** pop-up window: 
    ...
    1. Add the number of **Loss of pay days**. We automatically verify and compute the arrears amount. 
...
1. Click **ADD RLOP ARREARS** to confirm the amounts. 
