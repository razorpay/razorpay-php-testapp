...
![User roles available on the RazorpayX Payroll Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-user-roles.jpg.md)

Provide special access, like [administrator permissions](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/quickstart.md), to the people in your team. You can also [create custom roles](#create-user-roles). This is available with the [Elite and Enterprise Plans](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/plans.md) only. 
...
1. Go to the **User Roles** section. Click **CREATE/EDIT ROLES**. 
    ...
    On the User Roles & Permissions page, you can:
            ...
            1. Under each section, select the permissions applicable for the role. 
                ![Select or clear the permissions to modify user role](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-edit-user-role.jpg.md)
            ...
            1. You can either: 
                ...
                ![Create user roles on Dashbaord](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-create-custom-roles.jpg.md)
...
1. Select a role to assign from the drop-down list. 
    ![Assign a role to employee](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-assign-role.jpg.md)
...
> **Watch Out!**
> 
> Ensure that the person you provide special access/role/permissions to is already a part of your organisation's payroll. Know more about [adding people to Payroll](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/quickstart/#add-all-employees.md). 
> 
...
1. Click the role you must modify. The **Manage Role** page opens.
1. Click **DELETE ROLE**.
    ![Delete user role on Payroll Dashboard](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-delete-role.jpg.md)
...
You can also view the list of people who have special user roles assigned to them. To do so, navigate to **Settings** → **Collaborators**.
    ![List of employees with special permissions in Payroll.](@/Applications/MAMP/htdocs/new-docs/llm-content/assets/images/xpayroll-view-collaborators.jpg.md)

Once your users are all setup, you can start configuring their documents, leaves and attendance in [Leave Setup](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/leaves.md).

### Related Information

- [Audit Reporting](@/Applications/MAMP/htdocs/new-docs/llm-content/payroll/audit-reporting.md) 
