---
title: Sole Proprietorship | Current Account Documents
heading: Current Account Documents - Sole Proprietorship
description: List of documents required to open a Current Account powered by RazorpayX in partnership with RBL/Yes Bank for a sole proprietorship.
---

# Current Account Documents - Sole Proprietorship

This page has information on the documents required for a **Sole Proprietorship** firm to open a Current Account using RazorpayX in partnership with RBL/Yes Bank.
...
> 
> 
> - All KYC documents must include the company seal along with the sole proprietor's signature on all pages.
...
---
2 |  Individual CIF form and KYC documents for Proprietor.
---
3 | Foreign Account Tax Compliance Act (FATCA) declaration in the name of the entity.

## Documents Required

KYC documents for Proprietor.
...
---
6 | Sole Proprietorship covering letter (Attach to ₹600 duty stamp paper).
---
